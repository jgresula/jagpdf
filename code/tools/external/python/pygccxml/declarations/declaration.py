...
class location_t(object):
    ...
    def __init__(self, file_name='', line=-1 ):
        self._file_name = os.path.normcase(os.path.normpath(file_name))
        self._line = line
    ...
    def _set_file_name(self, new_file_name):
        self._file_name = os.path.normcase(os.path.normpath(new_file_name))
    ...
    def as_tuple( self ):
        ...
        return (os.path.normcase(os.path.abspath(self.file_name)), self.line)
