...
def radial_basic(doc, canvas):
    ...
    fn = doc.function_2_load("c0=0.0, 1.0, 0.0; c1=0.0, 0.0, 1.0")
...
def radial_background(doc, canvas):
    ...
    fn = doc.function_2_load("c0=0.0, 1.0, 0.0; c1=0, 0, 1")
...
def axial_stitching(doc, canvas):
    #009999 - #FF6600
    fn1 = doc.function_2_load("c0=0.0, 0.6, 0.6; c1=1.0, 0.4, 0.0")
    #FF6600 - #FFB200
    fn2 = doc.function_2_load("c0=1.0, 0.4, 0.0; c1=1.0, 0.7, 0.0")
    #FFB200 - #1919B3
    fn3 = doc.function_2_load("c0=1.0, 0.7, 0.0; c1=0.1, 0.1, 0.7")
    fn = doc.function_3_load("bounds=0.33, 0.66; encode=0, 1, 0, 1, 0, 1",
                             [fn1, fn2, fn3])
...
def function_multi(doc, canvas):
    ...
    sh = doc.shading_pattern_load("function; matrix_fun=100, 0, 0, 100, 50, 50", jagpdf.CS_DEVICE_RGB, [fn1, fn2, fn3])
    do_rectangle(canvas, sh)
...
def two_vertical_shadings(doc, canvas, cs1, cs2, c0, c1, c02=None, c12=None):
    ...
    c02 = c02 or c0
    c12 = c12 or c1
    fn_1 = doc.function_2_load("c0=%s; c1=%s" % (c2s(c0), c2s(c1)))
    fn_2 = doc.function_2_load("c0=%s; c1=%s" % (c2s(c02), c2s(c12)))
