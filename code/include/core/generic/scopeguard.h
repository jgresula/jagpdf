 ...
 *
 */
#ifndef __SCOPEGUARD_JAG_1640__
#define __SCOPEGUARD_JAG_1640__
...
#define ON_BLOCK_EXIT ScopeGuard ANONYMOUS_VARIABLE(scopeGuard) UNUSED_VAR= MakeGuard
#define ON_BLOCK_EXIT_OBJ ScopeGuard ANONYMOUS_VARIABLE(scopeGuard) UNUSED_VAR= MakeObjGuard

#endif //__SCOPEGUARD_JAG_1640__
