...
private:
    ...
    enum { temp2 = static_cast<size_t>(temp1) > sizeof(Align) ? static_cast<size_t>(temp1) : sizeof(Align) };
...
public:
    ...
    size_type capacity() const
    { return Small() ? static_cast<size_t>(maxSmallString) : static_cast<size_t>(GetStorage().capacity()); }
